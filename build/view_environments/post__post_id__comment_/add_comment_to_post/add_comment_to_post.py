...
from fb_post.build.serializers.definitions.CommentText.CommentTextSerializer import CommentTextSerializer
from fb_post.build.serializers.definitions.CommentId.CommentIdSerializer import CommentIdSerializer
...
options = {
    ...
    'REQUEST_SERIALIZER': CommentTextSerializer,
