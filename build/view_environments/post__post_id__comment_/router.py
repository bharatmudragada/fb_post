path_method_dict = {
    "post/(?P<post_id>\\w+)/comment/": {
        "POST": "add_comment_to_post"
    }
}


def post__post_id__comment_(request, *args, **kwargs):
    ...
    response = router_wrapper("fb_post", "post__post_id__comment_", operations_dict, request, *args, **kwargs)
    return response