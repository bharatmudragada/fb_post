...
from fb_post.build.serializers.definitions.ReplyCommentId.ReplyCommentIdSerializer import ReplyCommentIdSerializer
...
app_name = "fb_post"
operation_id  = "add_reply_to_comment"
group_name = ""
...
def add_reply_to_comment(request, *args, **kwargs):
    ...
    return view_env_wrapper(app_name, "add_reply_to_comment", group_name, *args, **kwargs)
