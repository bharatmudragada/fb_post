...
from fb_post.build.view_environments.posts_user_.get_user_posts.GetUserPostsRequestQueryParamSerializer import GetUserPostsRequestQueryParamSerializer
from fb_post.build.responses.GetUserPostResponse.GetUserPostResponse.GetUserPostResponseSerializer import GetUserPostResponseSerializer
...
options = {
    ...
    'REQUEST_QUERY_PARAMS_SERIALIZER': GetUserPostsRequestQueryParamSerializer,
    ...
    'RESPONSE': {
        ...
        '201' : {
           'RESPONSE_SERIALIZER': GetUserPostResponseSerializer,
...
def get_user_posts(request, *args, **kwargs):
    args = (request,) + args
    from django_swagger_utils.drf_server.wrappers.view_env_wrapper import view_env_wrapper
    return view_env_wrapper(app_name, "get_user_posts", group_name, *args, **kwargs)
