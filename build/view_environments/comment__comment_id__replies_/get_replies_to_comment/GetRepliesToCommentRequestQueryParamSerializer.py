...
class GetRepliesToCommentRequestQueryParamType(object):
...
class GetRepliesToCommentRequestQueryParamSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        return GetRepliesToCommentRequestQueryParamType(**validated_data)
