class GetUserPostResponseResponse(object):
    ...
    def get_response():
        response = {
            ...
            "response_serializer_import_str": "from fb_post.build.responses.GetUserPostResponse.GetUserPostResponse.GetUserPostResponseSerializer import GetUserPostResponseSerializer",
