...
class GetPostIdListResponseType(object):
    def __init__(self, post_ids=None,  **kwargs):
...
class GetPostIdListResponseSerializer(serializers.Serializer):
    post_ids = serializers.ListField(child=serializers.IntegerField(), required=False)

    def create(self, validated_data):
        return GetPostIdListResponseType(**validated_data)
